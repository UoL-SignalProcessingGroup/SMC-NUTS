...
def main():
    ...
    for i in range(len(true_mean)):
        ...
        # axs[0].plot(np.repeat(true_mean[i], asymptotic_mean_of_mean.shape[0]), linestyle="--", color="g")
        # axs[1].plot(np.repeat(true_mean[i], asymptotic_mean_of_mean.shape[0]), linestyle="--", color="g")
        # axs[2].plot(np.repeat(true_mean[i], asymptotic_mean_of_mean.shape[0]), linestyle="--", color="g")
    ...
    # plt.plot(np.log(asymptotic_mean_of_mean_mse), "k", label="i")
    # plt.plot(np.log(fp_mean_of_mean_mse), "b", label="ii")
    # plt.plot(np.log(gauss_mean_of_mean_mse), "r", label="iii")
    plt.plot(asymptotic_mean_of_mean_mse, "k", label="i")
    # plt.fill_between(range(len(asymptotic_mean_of_mean_mse)), asymptotic_mean_of_mean_mse - asymptotic_sd_of_mean_mse, asymptotic_mean_of_mean_mse + asymptotic_sd_of_mean_mse, alpha=0.2)
    plt.plot(fp_mean_of_mean_mse, "b", label="ii")
    # plt.fill_between(range(len(asymptotic_mean_of_mean_mse)), fp_mean_of_mean_mse - fp_sd_of_mean_mse, fp_mean_of_mean_mse + fp_sd_of_mean_mse, alpha=0.2)
    plt.plot(gauss_mean_of_mean_mse, "r", label="iii")
    # plt.fill_between(range(len(asymptotic_mean_of_mean_mse)), gauss_mean_of_mean_mse - gauss_sd_of_mean_mse, gauss_mean_of_mean_mse + gauss_sd_of_mean_mse, alpha=0.2)
    plt.legend()
